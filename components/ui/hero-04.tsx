    ...
    <section className="min-h-[85vh] overflow-hidden relative pt-20 pb-2">
      <div className="mx-auto max-w-7xl relative z-20 px-6">
        <div className="relative ">
          ...
          <h1
            className={`z-20 text-base-content relative font-bold text-center tracking-[-7px] text-7xl md:text-9xl xl:tracking-[-1rem] md:tracking-[-14px] xl:text-[10rem]`}
          >
            CREATIVE DEVELOPER
          </h1>
          <p className="text-4xl absolute -bottom-12 left-10 md:left-24 font-thin tracking-[6px]">
            SEHAN ALFARISI
          </p>
        </div>
        ...
        <div className="grid relative">
          ...
          <div className="flex md:hidden left-1/2 -top-10 w-full md:w-fit overflow-hidden bg-base-200">
            <img
              src="/images/projects/foto-saya.png"
              alt="Sehan Alfarisi"
              className="h-100 w-full object-contain grayscale"
