...
export const MinimalistHero = ({
  ...
  const showFooter = hasSocialLinks || hasLocation;
  ...
  return (
    ...
    >
      <header className={cn("z-30 flex w-full max-w-7xl items-center", hasNavLinks ? "justify-between" : "justify-start")}>
        <motion.div
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          <h1 className="font-display text-7xl font-extrabold text-foreground md:text-8xl lg:text-9xl">
            {overlayText.part1}
            <br />
            {overlayText.part2}
          </h1>
